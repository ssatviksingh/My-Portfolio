    ...
    <MouseParallaxWrapper intensity={20}>
      <div className="px-6 pt-24 pb-20">
        <div className="mx-auto max-w-4xl rounded-3xl border border-slate-800 bg-deep-blue-soft/80 p-8 shadow-soft-glow">
          ...
          <p className="text-text-muted text-sm mb-8">Last updated: 2026</p>
          ...
          >
            <p>
              This website is a personal portfolio created to showcase my work,
              projects, and experience. I do{" "}
              <strong>
                not collect, store, or share any personal information
              </strong>
              from visitors.
            </p>
            ...
            <h2>Analytics</h2>
            <p>
              This website does <strong>not use cookies or analytics</strong>{" "}
              unless explicitly added in the future. If tools like Google
              Analytics or Vercel Analytics are enabled later, they would only
              collect anonymous usage information (such as page views, device
              type, and time spent on pages).
            </p>

            <h2>External Links</h2>
            <p>
              This website contains links to external sites such as GitHub,
              LinkedIn, or email. These websites have their own privacy
              policies, and I am not responsible for their content or data
              handling.
            </p>
            ...
            <p className="font-medium text-text-dark-main underline decoration-accent-gold decoration-2 underline-offset-4">
