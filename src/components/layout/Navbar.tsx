  ...
  return (
    <header className="fixed top-0 z-40 w-full border-b border-slate-200/60 bg-bg-light/95 backdrop-blur-lg transition-colors duration-300 dark:border-slate-800/60 dark:bg-bg-dark/95">
      <nav className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6">
        ...
        <button
          className="inline-flex items-center justify-center rounded-xl border border-slate-200 bg-slate-100 p-2 text-text-light-main dark:border-slate-700 dark:bg-slate-800 dark:text-text-dark-main md:hidden"
          onClick={() => setOpen((o) => !o)}
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="border-t border-slate-200/60 bg-bg-light/95 px-4 pb-4 pt-2 dark:border-slate-800/60 dark:bg-bg-dark/95 md:hidden"
          >
                    ...
                    <NavLink
                      ...
                      className={() =>
                        `block rounded-xl px-3 py-2 transition-colors ${
                          isActive
                            ? 'bg-slate-200 font-semibold text-brand-blue dark:bg-slate-800 dark:text-brand-blue-light'
                            : 'text-text-light-muted hover:bg-slate-100 hover:text-text-light-main dark:text-text-dark-muted dark:hover:bg-slate-800/50 dark:hover:text-text-dark-main'
                        }`
                      }
                    >
                      {link.label}
